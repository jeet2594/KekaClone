...
const RoleList = () => {
  const [roles, setPermissions] = useState<Role[]>([])
  ...
  const deleteRole = (id: number, index: number) => {
    Swal.fire({
      title: 'Are you sure?',
                ...
                >
                  <thead>
                    <tr className='text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0'>
                      ...
                      <th className='min-w-125px'>Role Name</th>
